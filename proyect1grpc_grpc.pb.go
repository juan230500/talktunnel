...
func (c *chatServiceClient) ChatStream(ctx context.Context, opts ...grpc.CallOption) (ChatService_ChatStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &ChatService_ServiceDesc.Streams[0], "/talktunnel.ChatService/ChatStream", opts...)
	if err != nil {
		return nil, err
	}
...
var ChatService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "talktunnel.ChatService",
